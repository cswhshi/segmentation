...
optimizer = torch.optim.SGD(train_params,lr=0.001, momentum=0.9,weight_decay=5e-4, nesterov=False)

scheduler = lr_scheduler.StepLR(optimizer, 10, gamma=0.9, last_epoch=-1)
